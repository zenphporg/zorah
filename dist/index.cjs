var n,
  ...
  t = function (n, r, t) {
    ...
    try {
      ...
      if (
        (e = n.split('.').reduce(
          ...
          null == t || null == (i = t.translations[o]) ? void 0 : i.php,
        ))
      )
        return u(e, r);
    } catch (n) {}
    try {
      var l,
        c = null == t || null == (l = t.translations[o]) ? void 0 : l.json;
      if ((c && !Array.isArray(c) && (e = c[n]), e)) return u(e, r);
    } catch (n) {}
    return u(n, r);
  },
  u = function (n, r) {
  ...
  i = {
    install: function (n, u) {
      (u && r(u),
        n.mixin({
          methods: {
            __: function (n, r, o) {
              return (void 0 === o && (o = u), t(n, r, o));
            },
            trans: function (n, r, o) {
              return (void 0 === o && (o = u), t(n, r, o));
            },
          },
        }));
